...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2026 at 09:15 AM
...
(1, 'proyektor', 1, 5, 'baik', 'tersedia'),
(2, 'laptop', 1, 5, 'baik', 'tersedia'),
(5, 'Microphone', 3, 5, 'baik', 'tersedia');
...
(2, 'Peralatan Kantor', 'peralatan kantor'),
...
CREATE TABLE `peminjaman` (
  ...
  `status` enum('dipinjam','selesai') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'Petugas', 'petugas', '12345', 'petugas'),
(3, 'User', 'user', '12345', 'peminjam');
